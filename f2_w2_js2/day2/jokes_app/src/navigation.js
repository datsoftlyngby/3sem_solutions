...
// let s1Content, s2Content, s3Content;
// const saveContent= (id)=>{
//     s1Content = sectionEx1;
//     s2Content = sectionEx2;
//     s3Content = sectionEx3;
// }
// saveContent();
...
//     s1Content = sectionEx1.innerHTML? sectionEx1:s1Content; 
//     sectionEx1.innerHTML = '';
//     s2Content = sectionEx2.innerHTML? sectionEx2:s2Content; 
//     sectionEx2.innerHTML = '';
//     s3Content = sectionEx3.innerHTML? sectionEx3:s3Content; 
